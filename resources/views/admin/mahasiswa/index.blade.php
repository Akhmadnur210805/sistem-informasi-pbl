            ...
            <table class="table table-hover table-striped">
                ...
                <tbody>
                    ...
                    @empty
                        {{-- JIKA DATA KOSONG --}}
                        <tr>
                            <td colspan="7" class="text-center">Data mahasiswa masih kosong.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('admin.mahasiswa.import') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        {{-- INSTRUKSI PENTING YANG SUDAH DIPERBAIKI --}}
                        <div class="alert alert-info">
                            <b>Penting!</b> Pastikan baris pertama file Excel Anda adalah header dengan nama kolom: <br>
                            <code class="text-dark">nim, nama, email, kelas, kelompok, password</code>
                        </div>
                        <div class="mb-3">
