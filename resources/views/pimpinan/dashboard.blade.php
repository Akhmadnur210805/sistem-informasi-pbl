...
<div class="container-fluid pb-5">
    ...
    <div class="row g-4 mb-5">
        <div class="col-sm-6 col-xl-3">
            <div class="card stat-card border-0 bg-white h-100">
                <div class="card-body p-4 d-flex flex-column justify-content-center">
                    <div class="icon-box mb-3" style="background-color: #f3f4f6; color: #4b5563;">
                        <i class="bi bi-file-earmark-text"></i>
                    </div>
                    <p class="text-muted small fw-bold mb-1 text-uppercase">Total Pengajuan</p>
        ...
        <div class="col-sm-6 col-xl-3">
            <div class="card stat-card border-0 bg-white h-100">
                <div class="card-body p-4 d-flex flex-column justify-content-center">
                    <div class="icon-box mb-3" style="background-color: #fffbeb; color: #d97706;">
                        <i class="bi bi-hourglass-split"></i>
                    </div>
                    <p class="text-muted small fw-bold mb-1 text-uppercase">Menunggu Proses</p>
        ...
        <div class="col-sm-6 col-xl-3">
            <div class="card stat-card border-0 bg-white h-100">
                <div class="card-body p-4 d-flex flex-column justify-content-center">
                    <div class="icon-box mb-3" style="background-color: #f0fdf4; color: #15803d;">
                        <i class="bi bi-check-circle-fill"></i>
                    </div>
                    <p class="text-muted small fw-bold mb-1 text-uppercase">Telah Disetujui</p>
        ...
        <div class="col-sm-6 col-xl-3">
            <div class="card stat-card border-0 bg-white h-100">
                <div class="card-body p-4 d-flex flex-column justify-content-center">
                    <div class="icon-box mb-3" style="background-color: #fef2f2; color: #b91c1c;">
                        <i class="bi bi-x-circle-fill"></i>
                    </div>
                    <p class="text-muted small fw-bold mb-1 text-uppercase">Ditolak</p>
            ...
            <div class="card border-0 shadow-sm overflow-hidden" style="border-radius: 20px;">
                ...
                <div class="card-body px-4 pb-4 pt-0">
                    <div class="row g-3">
                        ...
                        {{-- KARTU CETAK LAPORAN --}}
                        <div class="col-md-6">
                            <a href="{{ route('pimpinan.laporan.index') }}" class="text-decoration-none d-block report-link">
                                <div class="p-4 rounded-4 border bg-light report-card d-flex align-items-center position-relative" style="z-index: 5;">
                                    <div class="rounded-circle bg-success text-white d-flex align-items-center justify-content-center me-3 flex-shrink-0" style="width: 55px; height: 55px;">
                        ...
                        {{-- KARTU PANTAU DATA MUSTAHIK --}}
                        <div class="col-md-6">
                            <a href="{{ route('pimpinan.mustahik.index') }}" class="text-decoration-none d-block report-link">
                                <div class="p-4 rounded-4 border bg-light report-card d-flex align-items-center position-relative" style="z-index: 5;">
                                    <div class="rounded-circle d-flex align-items-center justify-content-center me-3 flex-shrink-0" 
                                         style="width: 55px; height: 55px; background-color: #1b7a43;">
                                        <i class="bi bi-pie-chart-fill text-white fs-5"></i>
                                    </div>
                                    <div>
...
<style>
    ...
    /* Memastikan area klik mencakup seluruh kartu */
    .report-link {
        display: block;
        width: 100%;
    }
