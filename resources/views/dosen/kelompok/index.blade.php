...
<style>
    ...
    /* Warna-warni border atas kartu berdasarkan urutan */
...
@section('content-header')
    <div class="row mb-3 align-items-end">
        <div class="col-sm-6">
            <h1 class="m-0 text-dark" style="font-weight: 700;">Data Kelompok PBL</h1>
        ...
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-end">
                ...
                <li class="breadcrumb-item active">Kelompok PBL</li>
            </ol>
        </div>
    </div>
@endsection
    ...
    @empty
        <div class="col-12">
            <div class="alert alert-light border text-center py-5 shadow-sm">
                ...
                <p class="text-secondary small">Data akan muncul setelah mahasiswa memilih kelompoknya.</p>
            </div>
        </div>
    @endforelse
</div>
